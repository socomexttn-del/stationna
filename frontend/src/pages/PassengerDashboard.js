        ...
        (error) => {
          ...
          switch (error.code) {
            ...
            case error.POSITION_UNAVAILABLE:
              toast.error('Position non disponible. Vérifiez votre GPS.', { duration: 4000 });
              break;
            case error.TIMEOUT:
              toast.info('Délai dépassé. Cliquez sur le bouton de localisation ou entrez votre adresse.', { duration: 4000 });
              break;
            default:
